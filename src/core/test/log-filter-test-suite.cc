  ...
  private:
    void DoRun() override
    {
        ...
        NS_TEST_ASSERT_MSG_NE(output.find("at-2s"),
                              std::string::npos,
                              "Message at 2s should pass");
        NS_TEST_ASSERT_MSG_NE(output.find("at-3s"),
                              std::string::npos,
                              "Message at 3s should pass");
        NS_TEST_ASSERT_MSG_NE(output.find("at-4s"),
                              std::string::npos,
                              "Message at 4s should pass");
...
class LogFilterAddNodeTestCase : public TestCase
{
  ...
  private:
    void DoRun() override
    {
        ...
        NS_TEST_ASSERT_MSG_NE(output.find("node-1"),
                              std::string::npos,
                              "Node 1 should pass");
